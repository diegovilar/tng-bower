...
var ModalServiceDecorator = (function () {
    ...
    ModalServiceDecorator.prototype.decorate = function ($modal, $injector) {
        ...
        $modal.open = function (optionsOrModal) {
            if (typeof optionsOrModal === 'function') {
                var handler = modal_1.getModalHandler(optionsOrModal);
    ...
    Object.defineProperty(ModalServiceDecorator.prototype, "decorate",
        __decorate([
            __param(0, di_1.Inject('$delegate')),
            __param(1, di_1.Inject('$injector'))
        ], ModalServiceDecorator.prototype, "decorate", Object.getOwnPropertyDescriptor(ModalServiceDecorator.prototype, "decorate")));
...
function inFactory(ddo, $injector) {
    ...
    if (utils_1.isFunction(ddo.link)) {
        ddo.link = !di_1.isAnnotated(ddo.link) ? ddo.link :
...
function registerFilter(filterClass, ngModule) {
    ...
    ngModule.filter(name, di_1.injectable(['$injector'], function ($injector) {
